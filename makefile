...
LDFLAGS = -lmingw32 -mwindows -mconsole $(SDL_LIB) -lws2_32  -lpthreadGC2 -liconv -lsqlite3dll -lpsapi
EXE = main.exe
...
OBJS =  obj/main.o obj/flux_correction.o obj/timer.o obj/db.o obj/file.o obj/soc.o
